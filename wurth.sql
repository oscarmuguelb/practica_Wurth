...
CREATE TABLE `producto` (
  ...
  KEY `producto_ibfk_1` (`categoria_id`),
  CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`),
  CONSTRAINT `producto_ibfk_2` FOREIGN KEY (`usuario_registro`) REFERENCES `usuario` (`id`)
...
-- Dump completed on 2023-11-16 11:43:59
